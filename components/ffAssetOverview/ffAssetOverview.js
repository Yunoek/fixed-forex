...
function StakedIcon(props) {
  const { color, className } = props;
  return (
    <SvgIcon viewBox="0 0 48 48" strokeWidth="2" className={className}>
      <g strokeWidth="2" transform="translate(0, 0)"><line data-cap="butt" x1="23" y1="25" x2="45" y2="3" fill="none" stroke="#ffffff" strokeMiterlimit="10" strokeWidth="2" strokeLinecap="butt" strokeLinejoin="miter"></line> <line data-color="color-2" x1="5" y1="4" x2="17" y2="16" fill="none" stroke="#ffffff" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="2" strokeLinejoin="miter"></line> <line data-color="color-2" x1="5" y1="16" x2="17" y2="4" fill="none" stroke="#ffffff" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="2" strokeLinejoin="miter"></line> <line data-color="color-2" x1="32" y1="31" x2="44" y2="43" fill="none" stroke="#ffffff" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="2" strokeLinejoin="miter"></line> <line data-color="color-2" x1="32" y1="43" x2="44" y2="31" fill="none" stroke="#ffffff" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="2" strokeLinejoin="miter"></line> <circle cx="11" cy="37" r="8" fill="none" stroke="#ffffff" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="2" strokeLinejoin="miter"></circle> <polyline points="31 3 45 3 45 17" fill="none" stroke="#ffffff" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="2" strokeLinejoin="miter"></polyline></g>
    </SvgIcon>
  );
}
